...
CODE1           DESC    <0FFFFH,,,ATCE,,>       ;0级代码段1描述符
CODE2           DESC    <0FFFFH,,,ATCE,,>       ;0级代码段2描述符
DSTACK			DESC    <0FFFFH,,,ATDW,,>	    ;0级堆栈段描述符
DATAS			DESC	<0FFFFH,,,ATDW,,>	    ;源数据段描述符
DATAO			DESC	<0FFFFH,3000H,,ATDW,,>	;目的数据段描述符
LDTLEN          =       $-LDT                   ;局部描述符表长度
CODE1_SEL       =       0000H+TIL  ;CODE1-LDT+TIL       ;代码段1的选择子
CODE2_SEL       =       0008H+TIL  ;CODE2-LDT+TIL       ;代码段2的选择子
DSTACK_SEL		=       0010H+TIL  ;DSTACK-LDT+TIL		;0级堆栈描述符选择子
DATAS_SEL		=       0018H+TIL  ;DATAS-LDT+TIL		;源数据段描述符选择子
DATAO_SEL		=       0020H+TIL  ;DATAO-LDT+TIL		;目的数据段描述符选择子
DSEG1            ENDS                        ;数据段定义结束
;----------------------------------------------------------------------------
...
VIRTUAL:    										;现在开始在保护方式下运行
            ...
            CALL16  CODE1_SEL,0						;跳转到演示任务代码段1
